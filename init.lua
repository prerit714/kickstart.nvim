...
-- NOTE: Using 2 spaces wide rendering of a single tab
vim.opt.tabstop = 2

-- INFO: I have noticed that 2 space render works really well with wide fonts
-- like 'Source Code Pro'; Hence the reason for the same
